...
class Goods(models.Model):
    ...
    goods_desc = UEditorField(verbose_name=u"内容", default='')
...
class  BannerLBT(models.Model):
    add_time=models.DateTimeField('添加时间',default=datetime.now)
    active=models.BooleanField(default=False)
    images= models.ImageField(upload_to="banner/", null=True, blank=True, verbose_name="封面图")
    goods=models.ForeignKey(Goods,on_delete=models.CASCADE, verbose_name="商品类目")
...
class  ShopBanner(models.Model):
    add_time = models.DateTimeField('添加时间', default=datetime.now)
    images = models.ImageField(upload_to="goods/banner/", null=True, blank=True, verbose_name="封面图")
    goods=models.ForeignKey(Goods,on_delete=models.CASCADE, verbose_name="商品类目",related_name='image')
